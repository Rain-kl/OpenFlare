...
import {getProxyRoute, updateProxyRoute,} from '@/features/proxy-routes/api/proxy-routes';
import {getWAFSiteRuleGroups, replaceWAFSiteRuleGroups,} from '@/features/waf/api/waf';
...
import type {ProxyRouteItem, ProxyRouteMutationPayload,} from '@/features/proxy-routes/types';
