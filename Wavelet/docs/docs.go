...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "agent.BufferedObservabilityRecord": {
            "type": "object",
            "properties": {
                "access_logs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/agent.NodeAccessLog"
                    }
                },
                "openresty_observation": {
                    "$ref": "#/definitions/agent.NodeOpenrestyObservation"
                },
                "snapshot": {
                    "$ref": "#/definitions/agent.NodeMetricSnapshot"
                },
                "traffic_report": {
                    "$ref": "#/definitions/agent.NodeTrafficReport"
                },
        ...
        "agent.NodeOpenrestyObservation": {
            "type": "object",
            "properties": {
                "captured_at_unix": {
                    "type": "integer"
        ...
        "agent.NodePayload": {
            ...
            "properties": {
                ...
                "buffered_observability": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/agent.BufferedObservabilityRecord"
                    }
                },
                "current_version": {
                    "type": "string"
                ...
                "health_events": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/agent.NodeHealthEvent"
                    }
                },
                "ip": {
                    "type": "string"
                ...
                "profile": {
                    "$ref": "#/definitions/agent.NodeSystemProfile"
                },
                "snapshot": {
                    "$ref": "#/definitions/agent.NodeMetricSnapshot"
                },
        ...
        "flared.HeartbeatPayload": {
            ...
            "properties": {
                ...
                "connected_relays": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/flared.ConnectedRelay"
                    }
                },
                "current_checksum": {
                    "type": "string"
        ...
        "flared.HeartbeatResponse": {
            ...
            "properties": {
                "active_config": {
                    "$ref": "#/definitions/flared.ActiveConfigMeta"
                },
                "tunnel_settings": {
                    "$ref": "#/definitions/relay.Settings"
                }
            }
        },
        "flared.ProxyEntry": {
        ...
        "flared.TunnelConfigResponse": {
            ...
            "properties": {
                ...
                "proxies": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/flared.ProxyEntry"
                    }
                },
                "relays": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/flared.RelayInfo"
                    }
                },
                "version": {
                    "type": "string"
        ...
        "relay.HeartbeatPayload": {
            ...
            "properties": {
                ...
                "frps_proxies": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/relay.ProxyStat"
                    }
                },
                "frps_proxy_count": {
                    "type": "integer"
